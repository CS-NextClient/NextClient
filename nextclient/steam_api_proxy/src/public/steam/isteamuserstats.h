...
public:
	...
	// callback.
	virtual bool InstallPS3Trophies();
	...
	virtual uint64 GetTrophySpaceRequiredBeforeInstall();
	...
	virtual bool SetUserStatsData( const void *pvData, uint32 cubData );
	...
	// buffer size.
	virtual bool GetUserStatsData( void *pvData, uint32 cubData, uint32 *pcubWritten );
#endif
};
