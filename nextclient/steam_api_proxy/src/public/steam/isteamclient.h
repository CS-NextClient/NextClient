...
#ifdef _PS3
	virtual ISteamPS3OverlayRender *GetISteamPS3OverlayRender();
#endif
...
{
public:
	virtual const char *GetCallbackName() const;
	virtual uint32 GetCallbackID() const;
	virtual uint8 *GetFixedData() const;
	virtual uint32 GetFixedSize() const;
	virtual uint32 GetNumMemberVariables() const;
