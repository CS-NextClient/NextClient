...
public:
	...
	CSteamID()
	{
		m_steamid.m_comp.m_unAccountID;
	...
	void ConvertToSteam2( TSteamGlobalUserID *pTSteamGlobalUserID ) const
	{
		...
		pTSteamGlobalUserID->m_SteamInstanceID;
	...
	void ClearIndividualInstance()				{ if ( BIndividualAccount() ) m_steamid.m_comp.m_unAccountInstance; }
