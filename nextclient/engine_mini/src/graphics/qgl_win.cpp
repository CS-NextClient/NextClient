...
qboolean QGL_Init()
{
    ...
    qglAccum = dllAccum = GPA(qglAccum, "glAccum");
    qglAlphaFunc = dllAlphaFunc = GPA(qglAlphaFunc, "glAlphaFunc");
    qglAreTexturesResident = dllAreTexturesResident = GPA(qglAreTexturesResident, "glAreTexturesResident");
    qglArrayElement = dllArrayElement = GPA(qglArrayElement, "glArrayElement");
    qglBegin = dllBegin = GPA(qglBegin, "glBegin");
    qglBindTexture = GPA(qglBindTexture, "glBindTexture");
    qglBitmap = GPA(qglBitmap, "glBitmap");
    qglBlendFunc = GPA(qglBlendFunc, "glBlendFunc");
    qglCallList = GPA(qglCallList, "glCallList");
    qglCallLists = GPA(qglCallLists, "glCallLists");
    qglClear = GPA(qglClear, "glClear");
    qglClearAccum = GPA(qglClearAccum, "glClearAccum");
    qglClearColor = GPA(qglClearColor, "glClearColor");
    qglClearDepth = GPA(qglClearDepth, "glClearDepth");
    qglClearIndex = GPA(qglClearIndex, "glClearIndex");
    qglClearStencil = GPA(qglClearStencil, "glClearStencil");
    qglClipPlane = GPA(qglClipPlane, "glClipPlane");
    qglColor3b = GPA(qglColor3b, "glColor3b");
    qglColor3bv = GPA(qglColor3bv, "glColor3bv");
    qglColor3d = GPA(qglColor3d, "glColor3d");
    qglColor3dv = GPA(qglColor3dv, "glColor3dv");
    qglColor3f = GPA(qglColor3f, "glColor3f");
    qglColor3fv = GPA(qglColor3fv, "glColor3fv");
    qglColor3i = GPA(qglColor3i, "glColor3i");
    qglColor3iv = GPA(qglColor3iv, "glColor3iv");
    qglColor3s = GPA(qglColor3s, "glColor3s");
    qglColor3sv = GPA(qglColor3sv, "glColor3sv");
    qglColor3ub = GPA(qglColor3ub, "glColor3ub");
    qglColor3ubv = GPA(qglColor3ubv, "glColor3ubv");
    qglColor3ui = GPA(qglColor3ui, "glColor3ui");
    qglColor3uiv = GPA(qglColor3uiv, "glColor3uiv");
    qglColor3us = GPA(qglColor3us, "glColor3us");
    qglColor3usv = GPA(qglColor3usv, "glColor3usv");
    qglColor4b = GPA(qglColor4b, "glColor4b");
    qglColor4bv = GPA(qglColor4bv, "glColor4bv");
    qglColor4d = GPA(qglColor4d, "glColor4d");
    qglColor4dv = GPA(qglColor4dv, "glColor4dv");
    qglColor4f = GPA(qglColor4f, "glColor4f");
    qglColor4fv = GPA(qglColor4fv, "glColor4fv");
    qglColor4i = GPA(qglColor4i, "glColor4i");
    qglColor4iv = GPA(qglColor4iv, "glColor4iv");
    qglColor4s = GPA(qglColor4s, "glColor4s");
    qglColor4sv = GPA(qglColor4sv, "glColor4sv");
    qglColor4ub = GPA(qglColor4ub, "glColor4ub");
    qglColor4ubv = GPA(qglColor4ubv, "glColor4ubv");
    qglColor4ui = GPA(qglColor4ui, "glColor4ui");
    qglColor4uiv = GPA(qglColor4uiv, "glColor4uiv");
    qglColor4us = GPA(qglColor4us, "glColor4us");
    qglColor4usv = GPA(qglColor4usv, "glColor4usv");
    qglColorMask = GPA(qglColorMask, "glColorMask");
    qglColorMaterial = GPA(qglColorMaterial, "glColorMaterial");
    qglColorPointer = GPA(qglColorPointer, "glColorPointer");
    qglCopyPixels = GPA(qglCopyPixels, "glCopyPixels");
    qglCopyTexImage1D = GPA(qglCopyTexImage1D, "glCopyTexImage1D");
    qglCopyTexImage2D = GPA(qglCopyTexImage2D, "glCopyTexImage2D");
    qglCopyTexSubImage1D = GPA(qglCopyTexSubImage1D, "glCopyTexSubImage1D");
    qglCopyTexSubImage2D = GPA(qglCopyTexSubImage2D, "glCopyTexSubImage2D");
    qglCullFace = GPA(qglCullFace, "glCullFace");
    qglDeleteLists = GPA(qglDeleteLists, "glDeleteLists");
    qglDeleteTextures = GPA(qglDeleteTextures, "glDeleteTextures");
    qglDepthFunc = GPA(qglDepthFunc, "glDepthFunc");
    qglDepthMask = GPA(qglDepthMask, "glDepthMask");
    qglDepthRange = GPA(qglDepthRange, "glDepthRange");
    qglDisable = GPA(qglDisable, "glDisable");
    qglDisableClientState = GPA(qglDisableClientState, "glDisableClientState");
    qglDrawArrays = GPA(qglDrawArrays, "glDrawArrays");
    qglDrawBuffer = GPA(qglDrawBuffer, "glDrawBuffer");
    qglDrawElements = GPA(qglDrawElements, "glDrawElements");
    qglDrawPixels = GPA(qglDrawPixels, "glDrawPixels");
    qglEdgeFlag = GPA(qglEdgeFlag, "glEdgeFlag");
    qglEdgeFlagPointer = GPA(qglEdgeFlagPointer, "glEdgeFlagPointer");
    qglEdgeFlagv = GPA(qglEdgeFlagv, "glEdgeFlagv");
    qglEnable = GPA(qglEnable, "glEnable");
    qglEnableClientState = GPA(qglEnableClientState, "glEnableClientState");
    qglEnd = GPA(qglEnd, "glEnd");
    qglEndList = GPA(qglEndList, "glEndList");
    qglEvalCoord1d = GPA(qglEvalCoord1d, "glEvalCoord1d");
    qglEvalCoord1dv = GPA(qglEvalCoord1dv, "glEvalCoord1dv");
    qglEvalCoord1f = GPA(qglEvalCoord1f, "glEvalCoord1f");
    qglEvalCoord1fv = GPA(qglEvalCoord1fv, "glEvalCoord1fv");
    qglEvalCoord2d = GPA(qglEvalCoord2d, "glEvalCoord2d");
    qglEvalCoord2dv = GPA(qglEvalCoord2dv, "glEvalCoord2dv");
    qglEvalCoord2f = GPA(qglEvalCoord2f, "glEvalCoord2f");
    qglEvalCoord2fv = GPA(qglEvalCoord2fv, "glEvalCoord2fv");
    qglEvalMesh1 = GPA(qglEvalMesh1, "glEvalMesh1");
    qglEvalMesh2 = GPA(qglEvalMesh2, "glEvalMesh2");
    qglEvalPoint1 = GPA(qglEvalPoint1, "glEvalPoint1");
    qglEvalPoint2 = GPA(qglEvalPoint2, "glEvalPoint2");
    qglFeedbackBuffer = GPA(qglFeedbackBuffer, "glFeedbackBuffer");
    qglFinish = GPA(qglFinish, "glFinish");
    qglFlush = GPA(qglFlush, "glFlush");
    qglFogf = GPA(qglFogf, "glFogf");
    qglFogfv = GPA(qglFogfv, "glFogfv");
    qglFogi = GPA(qglFogi, "glFogi");
    qglFogiv = GPA(qglFogiv, "glFogiv");
    qglFrontFace = GPA(qglFrontFace, "glFrontFace");
    qglFrustum = GPA(qglFrustum, "glFrustum");
    qglGenLists = GPA(qglGenLists, "glGenLists");
    qglGenTextures = GPA(qglGenTextures, "glGenTextures");
    qglGetBooleanv = GPA(qglGetBooleanv, "glGetBooleanv");
    qglGetClipPlane = GPA(qglGetClipPlane, "glGetClipPlane");
    qglGetDoublev = GPA(qglGetDoublev, "glGetDoublev");
    qglGetError = GPA(qglGetError, "glGetError");
    qglGetFloatv = GPA(qglGetFloatv, "glGetFloatv");
    qglGetIntegerv = GPA(qglGetIntegerv, "glGetIntegerv");
    qglGetLightfv = GPA(qglGetLightfv, "glGetLightfv");
    qglGetLightiv = GPA(qglGetLightiv, "glGetLightiv");
    qglGetMapdv = GPA(qglGetMapdv, "glGetMapdv");
    qglGetMapfv = GPA(qglGetMapfv, "glGetMapfv");
    qglGetMapiv = GPA(qglGetMapiv, "glGetMapiv");
    qglGetMaterialfv = GPA(qglGetMaterialfv, "glGetMaterialfv");
    qglGetMaterialiv = GPA(qglGetMaterialiv, "glGetMaterialiv");
    qglGetPixelMapfv = GPA(qglGetPixelMapfv, "glGetPixelMapfv");
    qglGetPixelMapuiv = GPA(qglGetPixelMapuiv, "glGetPixelMapuiv");
    qglGetPixelMapusv = GPA(qglGetPixelMapusv, "glGetPixelMapusv");
    qglGetPointerv = GPA(qglGetPointerv, "glGetPointerv");
    qglGetPolygonStipple = GPA(qglGetPolygonStipple, "glGetPolygonStipple");
    qglGetString = GPA(qglGetString, "glGetString");
    qglGetTexEnvfv = GPA(qglGetTexEnvfv, "glGetTexEnvfv");
    qglGetTexEnviv = GPA(qglGetTexEnviv, "glGetTexEnviv");
    qglGetTexGendv = GPA(qglGetTexGendv, "glGetTexGendv");
    ...
    qglIndexMask = GPA(qglIndexMask, "glIndexMask");
    qglIndexPointer = GPA(qglIndexPointer, "glIndexPointer");
    qglIndexd = GPA(qglIndexd, "glIndexd");
    qglIndexdv = GPA(qglIndexdv, "glIndexdv");
    qglIndexf = GPA(qglIndexf, "glIndexf");
    qglIndexfv = GPA(qglIndexfv, "glIndexfv");
    qglIndexi = GPA(qglIndexi, "glIndexi");
    qglIndexiv = GPA(qglIndexiv, "glIndexiv");
    qglIndexs = GPA(qglIndexs, "glIndexs");
    qglIndexsv = GPA(qglIndexsv, "glIndexsv");
    qglIndexub = GPA(qglIndexub, "glIndexub");
    qglIndexubv = GPA(qglIndexubv, "glIndexubv");
    qglInitNames = GPA(qglInitNames, "glInitNames");
    qglInterleavedArrays = GPA(qglInterleavedArrays, "glInterleavedArrays");
    qglIsEnabled = GPA(qglIsEnabled, "glIsEnabled");
    qglIsList = GPA(qglIsList, "glIsList");
    qglIsTexture = GPA(qglIsTexture, "glIsTexture");
    qglLightModelf = GPA(qglLightModelf, "glLightModelf");
    qglLightModelfv = GPA(qglLightModelfv, "glLightModelfv");
    qglLightModeli = GPA(qglLightModeli, "glLightModeli");
    qglLightModeliv = GPA(qglLightModeliv, "glLightModeliv");
    qglLightf = GPA(qglLightf, "glLightf");
    qglLightfv = GPA(qglLightfv, "glLightfv");
    qglLighti = GPA(qglLighti, "glLighti");
    qglLightiv = GPA(qglLightiv, "glLightiv");
    qglLineStipple = GPA(qglLineStipple, "glLineStipple");
    qglLineWidth = GPA(qglLineWidth, "glLineWidth");
    qglListBase = GPA(qglListBase, "glListBase");
    qglLoadIdentity = GPA(qglLoadIdentity, "glLoadIdentity");
    qglLoadMatrixd = GPA(qglLoadMatrixd, "glLoadMatrixd");
    qglLoadMatrixf = GPA(qglLoadMatrixf, "glLoadMatrixf");
    qglLoadName = GPA(qglLoadName, "glLoadName");
    qglLogicOp = GPA(qglLogicOp, "glLogicOp");
    qglMap1d = GPA(qglMap1d, "glMap1d");
    qglMap1f = GPA(qglMap1f, "glMap1f");
    qglMap2d = GPA(qglMap2d, "glMap2d");
    qglMap2f = GPA(qglMap2f, "glMap2f");
    qglMapGrid1d = GPA(qglMapGrid1d, "glMapGrid1d");
    qglMapGrid1f = GPA(qglMapGrid1f, "glMapGrid1f");
    qglMapGrid2d = GPA(qglMapGrid2d, "glMapGrid2d");
    qglMapGrid2f = GPA(qglMapGrid2f, "glMapGrid2f");
    qglMaterialf = GPA(qglMaterialf, "glMaterialf");
    qglMaterialfv = GPA(qglMaterialfv, "glMaterialfv");
    qglMateriali = GPA(qglMateriali, "glMateriali");
    qglMaterialiv = GPA(qglMaterialiv, "glMaterialiv");
    qglMatrixMode = GPA(qglMatrixMode, "glMatrixMode");
    qglMultMatrixd = GPA(qglMultMatrixd, "glMultMatrixd");
    qglMultMatrixf = GPA(qglMultMatrixf, "glMultMatrixf");
    qglNewList = GPA(qglNewList, "glNewList");
    qglNormal3b = GPA(qglNormal3b, "glNormal3b");
    qglNormal3bv = GPA(qglNormal3bv, "glNormal3bv");
    qglNormal3d = GPA(qglNormal3d, "glNormal3d");
    qglNormal3dv = GPA(qglNormal3dv, "glNormal3dv");
    qglNormal3f = GPA(qglNormal3f, "glNormal3f");
    qglNormal3fv = GPA(qglNormal3fv, "glNormal3fv");
    qglNormal3i = GPA(qglNormal3i, "glNormal3i");
    qglNormal3iv = GPA(qglNormal3iv, "glNormal3iv");
    qglNormal3s = GPA(qglNormal3s, "glNormal3s");
    qglNormal3sv = GPA(qglNormal3sv, "glNormal3sv");
    qglNormalPointer = GPA(qglNormalPointer, "glNormalPointer");
    qglOrtho = GPA(qglOrtho, "glOrtho");
    qglPassThrough = GPA(qglPassThrough, "glPassThrough");
    qglPixelMapfv = GPA(qglPixelMapfv, "glPixelMapfv");
    qglPixelMapuiv = GPA(qglPixelMapuiv, "glPixelMapuiv");
    qglPixelMapusv = GPA(qglPixelMapusv, "glPixelMapusv");
    qglPixelStoref = GPA(qglPixelStoref, "glPixelStoref");
    qglPixelStorei = GPA(qglPixelStorei, "glPixelStorei");
    qglPixelTransferf = GPA(qglPixelTransferf, "glPixelTransferf");
    qglPixelTransferi = GPA(qglPixelTransferi, "glPixelTransferi");
    qglPixelZoom = GPA(qglPixelZoom, "glPixelZoom");
    qglPointSize = GPA(qglPointSize, "glPointSize");
    qglPolygonMode = GPA(qglPolygonMode, "glPolygonMode");
    qglPolygonOffset = GPA(qglPolygonOffset, "glPolygonOffset");
    qglPolygonStipple = GPA(qglPolygonStipple, "glPolygonStipple");
    qglPopAttrib = GPA(qglPopAttrib, "glPopAttrib");
    qglPopClientAttrib = GPA(qglPopClientAttrib, "glPopClientAttrib");
    qglPopMatrix = GPA(qglPopMatrix, "glPopMatrix");
    qglPopName = GPA(qglPopName, "glPopName");
    qglPrioritizeTextures = GPA(qglPrioritizeTextures, "glPrioritizeTextures");
    qglPushAttrib = GPA(qglPushAttrib, "glPushAttrib");
    qglPushClientAttrib = GPA(qglPushClientAttrib, "glPushClientAttrib");
    qglPushMatrix = GPA(qglPushMatrix, "glPushMatrix");
    qglPushName = GPA(qglPushName, "glPushName");
    qglRasterPos2d = GPA(qglRasterPos2d, "glRasterPos2d");
    qglRasterPos2dv = GPA(qglRasterPos2dv, "glRasterPos2dv");
    qglRasterPos2f = GPA(qglRasterPos2f, "glRasterPos2f");
    qglRasterPos2fv = GPA(qglRasterPos2fv, "glRasterPos2fv");
    qglRasterPos2i = GPA(qglRasterPos2i, "glRasterPos2i");
    qglRasterPos2iv = GPA(qglRasterPos2iv, "glRasterPos2iv");
    qglRasterPos2s = GPA(qglRasterPos2s, "glRasterPos2s");
    qglRasterPos2sv = GPA(qglRasterPos2sv, "glRasterPos2sv");
    qglRasterPos3d = GPA(qglRasterPos3d, "glRasterPos3d");
    qglRasterPos3dv = GPA(qglRasterPos3dv, "glRasterPos3dv");
    qglRasterPos3f = GPA(qglRasterPos3f, "glRasterPos3f");
    qglRasterPos3fv = GPA(qglRasterPos3fv, "glRasterPos3fv");
    qglRasterPos3i = GPA(qglRasterPos3i, "glRasterPos3i");
    qglRasterPos3iv = GPA(qglRasterPos3iv, "glRasterPos3iv");
    qglRasterPos3s = GPA(qglRasterPos3s, "glRasterPos3s");
    qglRasterPos3sv = GPA(qglRasterPos3sv, "glRasterPos3sv");
    qglRasterPos4d = GPA(qglRasterPos4d, "glRasterPos4d");
    qglRasterPos4dv = GPA(qglRasterPos4dv, "glRasterPos4dv");
    qglRasterPos4f = GPA(qglRasterPos4f, "glRasterPos4f");
    qglRasterPos4fv = GPA(qglRasterPos4fv, "glRasterPos4fv");
    qglRasterPos4i = GPA(qglRasterPos4i, "glRasterPos4i");
    qglRasterPos4iv = GPA(qglRasterPos4iv, "glRasterPos4iv");
    qglRasterPos4s = GPA(qglRasterPos4s, "glRasterPos4s");
    qglRasterPos4sv = GPA(qglRasterPos4sv, "glRasterPos4sv");
    qglReadBuffer = GPA(qglReadBuffer, "glReadBuffer");
    qglReadPixels = GPA(qglReadPixels, "glReadPixels");
    qglRectd = GPA(qglRectd, "glRectd");
    qglRectdv = GPA(qglRectdv, "glRectdv");
    qglRectf = GPA(qglRectf, "glRectf");
    qglRectfv = GPA(qglRectfv, "glRectfv");
    qglRecti = GPA(qglRecti, "glRecti");
    qglRectiv = GPA(qglRectiv, "glRectiv");
    qglRects = GPA(qglRects, "glRects");
    qglRectsv = GPA(qglRectsv, "glRectsv");
    qglRenderMode = GPA(qglRenderMode, "glRenderMode");
    qglRotated = GPA(qglRotated, "glRotated");
    qglRotatef = GPA(qglRotatef, "glRotatef");
    qglScaled = GPA(qglScaled, "glScaled");
    qglScalef = GPA(qglScalef, "glScalef");
    qglScissor = GPA(qglScissor, "glScissor");
    qglSelectBuffer = GPA(qglSelectBuffer, "glSelectBuffer");
    qglShadeModel = GPA(qglShadeModel, "glShadeModel");
    qglStencilFunc = GPA(qglStencilFunc, "glStencilFunc");
    qglStencilMask = GPA(qglStencilMask, "glStencilMask");
    qglStencilOp = GPA(qglStencilOp, "glStencilOp");
    qglTexCoord1d = GPA(qglTexCoord1d, "glTexCoord1d");
    qglTexCoord1dv = GPA(qglTexCoord1dv, "glTexCoord1dv");
    qglTexCoord1f = GPA(qglTexCoord1f, "glTexCoord1f");
    qglTexCoord1fv = GPA(qglTexCoord1fv, "glTexCoord1fv");
    qglTexCoord1i = GPA(qglTexCoord1i, "glTexCoord1i");
    qglTexCoord1iv = GPA(qglTexCoord1iv, "glTexCoord1iv");
    qglTexCoord1s = GPA(qglTexCoord1s, "glTexCoord1s");
    qglTexCoord1sv = GPA(qglTexCoord1sv, "glTexCoord1sv");
    qglTexCoord2d = GPA(qglTexCoord2d, "glTexCoord2d");
    qglTexCoord2dv = GPA(qglTexCoord2dv, "glTexCoord2dv");
    qglTexCoord2f = GPA(qglTexCoord2f, "glTexCoord2f");
    qglTexCoord2fv = GPA(qglTexCoord2fv, "glTexCoord2fv");
    qglTexCoord2i = GPA(qglTexCoord2i, "glTexCoord2i");
    qglTexCoord2iv = GPA(qglTexCoord2iv, "glTexCoord2iv");
    qglTexCoord2s = GPA(qglTexCoord2s, "glTexCoord2s");
    qglTexCoord2sv = GPA(qglTexCoord2sv, "glTexCoord2sv");
    qglTexCoord3d = GPA(qglTexCoord3d, "glTexCoord3d");
    qglTexCoord3dv = GPA(qglTexCoord3dv, "glTexCoord3dv");
    qglTexCoord3f = GPA(qglTexCoord3f, "glTexCoord3f");
    qglTexCoord3fv = GPA(qglTexCoord3fv, "glTexCoord3fv");
    qglTexCoord3i = GPA(qglTexCoord3i, "glTexCoord3i");
    qglTexCoord3iv = GPA(qglTexCoord3iv, "glTexCoord3iv");
    qglTexCoord3s = GPA(qglTexCoord3s, "glTexCoord3s");
    qglTexCoord3sv = GPA(qglTexCoord3sv, "glTexCoord3sv");
    qglTexCoord4d = GPA(qglTexCoord4d, "glTexCoord4d");
    qglTexCoord4dv = GPA(qglTexCoord4dv, "glTexCoord4dv");
    qglTexCoord4f = GPA(qglTexCoord4f, "glTexCoord4f");
    qglTexCoord4fv = GPA(qglTexCoord4fv, "glTexCoord4fv");
    qglTexCoord4i = GPA(qglTexCoord4i, "glTexCoord4i");
    qglTexCoord4iv = GPA(qglTexCoord4iv, "glTexCoord4iv");
    qglTexCoord4s = GPA(qglTexCoord4s, "glTexCoord4s");
    qglTexCoord4sv = GPA(qglTexCoord4sv, "glTexCoord4sv");
    qglTexCoordPointer = GPA(qglTexCoordPointer, "glTexCoordPointer");
    qglTexEnvf = GPA(qglTexEnvf, "glTexEnvf");
    qglTexEnvfv = GPA(qglTexEnvfv, "glTexEnvfv");
    qglTexEnvi = GPA(qglTexEnvi, "glTexEnvi");
    qglTexEnviv = GPA(qglTexEnviv, "glTexEnviv");
    qglTexGend = GPA(qglTexGend, "glTexGend");
    qglTexGendv = GPA(qglTexGendv, "glTexGendv");
    qglTexGenf = GPA(qglTexGenf, "glTexGenf");
    qglTexGenfv = GPA(qglTexGenfv, "glTexGenfv");
    qglTexGeni = GPA(qglTexGeni, "glTexGeni");
    qglTexGeniv = GPA(qglTexGeniv, "glTexGeniv");
    qglTexImage1D = GPA(qglTexImage1D, "glTexImage1D");
    qglTexImage2D = GPA(qglTexImage2D, "glTexImage2D");
    qglTexParameterf = GPA(qglTexParameterf, "glTexParameterf");
    qglTexParameterfv = GPA(qglTexParameterfv, "glTexParameterfv");
    qglTexParameteri = GPA(qglTexParameteri, "glTexParameteri");
    qglTexParameteriv = GPA(qglTexParameteriv, "glTexParameteriv");
    qglTexSubImage1D = GPA(qglTexSubImage1D, "glTexSubImage1D");
    qglTexSubImage2D = GPA(qglTexSubImage2D, "glTexSubImage2D");
    qglTranslated = GPA(qglTranslated, "glTranslated");
    qglTranslatef = GPA(qglTranslatef, "glTranslatef");
    qglVertex2d = GPA(qglVertex2d, "glVertex2d");
    qglVertex2dv = GPA(qglVertex2dv, "glVertex2dv");
    qglVertex2f = GPA(qglVertex2f, "glVertex2f");
    qglVertex2fv = GPA(qglVertex2fv, "glVertex2fv");
    qglVertex2i = GPA(qglVertex2i, "glVertex2i");
    qglVertex2iv = GPA(qglVertex2iv, "glVertex2iv");
    qglVertex2s = GPA(qglVertex2s, "glVertex2s");
    qglVertex2sv = GPA(qglVertex2sv, "glVertex2sv");
    qglVertex3d = GPA(qglVertex3d, "glVertex3d");
    qglVertex3dv = GPA(qglVertex3dv, "glVertex3dv");
    qglVertex3f = GPA(qglVertex3f, "glVertex3f");
    qglVertex3fv = GPA(qglVertex3fv, "glVertex3fv");
    qglVertex3i = GPA(qglVertex3i, "glVertex3i");
    qglVertex3iv = GPA(qglVertex3iv, "glVertex3iv");
    qglVertex3s = GPA(qglVertex3s, "glVertex3s");
    qglVertex3sv = GPA(qglVertex3sv, "glVertex3sv");
    qglVertex4d = GPA(qglVertex4d, "glVertex4d");
    qglVertex4dv = GPA(qglVertex4dv, "glVertex4dv");
    qglVertex4f = GPA(qglVertex4f, "glVertex4f");
    qglVertex4fv = GPA(qglVertex4fv, "glVertex4fv");
    qglVertex4i = GPA(qglVertex4i, "glVertex4i");
    qglVertex4iv = GPA(qglVertex4iv, "glVertex4iv");
    qglVertex4s = GPA(qglVertex4s, "glVertex4s");
    qglVertex4sv = GPA(qglVertex4sv, "glVertex4sv");
    ...
    qwglDeleteContext = GPA(qwglDeleteContext, "wglDeleteContext");
    qwglDescribeLayerPlane = GPA(qwglDescribeLayerPlane, "wglDescribeLayerPlane");
    qwglGetCurrentContext = GPA(qwglGetCurrentContext, "wglGetCurrentContext");
    qwglGetCurrentDC = GPA(qwglGetCurrentDC, "wglGetCurrentDC");
    qwglGetLayerPaletteEntries = GPA(qwglGetLayerPaletteEntries, "wglGetLayerPaletteEntries");
    qwglGetProcAddress = GPA(qwglGetProcAddress, "wglGetProcAddress");
    qwglMakeCurrent = GPA(qwglMakeCurrent, "wglMakeCurrent");
    qwglRealizeLayerPalette = GPA(qwglRealizeLayerPalette, "wglRealizeLayerPalette");
    qwglSetLayerPaletteEntries = GPA(qwglSetLayerPaletteEntries, "wglSetLayerPaletteEntries");
    qwglShareLists = GPA(qwglShareLists, "wglShareLists");
    qwglSwapLayerBuffers = GPA(qwglSwapLayerBuffers, "wglSwapLayerBuffers");
    qwglUseFontBitmaps = GPA(qwglUseFontBitmaps, "wglUseFontBitmapsA");
    qwglUseFontOutlines = GPA(qwglUseFontOutlines, "wglUseFontOutlinesA");

    qwglChoosePixelFormat = GPA(qwglChoosePixelFormat, "wglChoosePixelFormat");
    qwglDescribePixelFormat = GPA(qwglDescribePixelFormat, "wglDescribePixelFormat");
    qwglGetPixelFormat = GPA(qwglGetPixelFormat, "wglGetPixelFormat");
    qwglSetPixelFormat = GPA(qwglSetPixelFormat, "wglSetPixelFormat");
