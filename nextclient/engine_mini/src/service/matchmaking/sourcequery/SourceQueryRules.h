...
class SourceQueryRules : public SourceQueryInterface
{
    SOCKET socket_{};
    concurrencpp::result_promise<SQResponseInfo<SQ_RULES>> response_promise_{};

public:
    explicit SourceQueryRules(SOCKET socket);

    concurrencpp::result<SQResponseInfo<SQ_RULES>> SendRulesQuery(netadr_t addr);
