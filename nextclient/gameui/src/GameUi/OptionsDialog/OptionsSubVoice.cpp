...
COptionsSubVoice::COptionsSubVoice(vgui2::Panel *parent) : PropertyPage(parent, NULL)
{
    ...
    m_pVoiceOverdriveSliderLabel = new vgui2::Label(this, "VoiceOverdriveLabel", "#GameUI_VoiceOverdrive");
    m_pVoiceOverdriveSlider = new CCvarSlider( this, "VoiceOverdrive", "#GameUI_VoiceOverdrive",
                                               1.0f, 10.0f, "voice_overdrive" );
...
void COptionsSubVoice::OnApplyChanges(void)
{
    ...
    m_pVoiceOverdriveSlider->ApplyChanges();
}
...
void COptionsSubVoice::StartTestMicrophone(void)
{
    ...
    if (m_pVoiceTweak->StartVoiceTweakMode())
    {
        ...
        m_pVoiceOverdriveSlider->SetEnabled(false);
        m_pVoiceOverdriveSliderLabel->SetEnabled(false);
...
void COptionsSubVoice::EndTestMicrophone(void)
{
    ...
    m_pVoiceOverdriveSlider->SetEnabled(true);
    m_pVoiceOverdriveSliderLabel->SetEnabled(true);
